...
mnist_classes = ['Class 1', 'Class 2', 'Class 3', 'Class 4','Class 5','Class 6','Class 7','Class 8']
...
def plot_embeddings(embeddings, targets,graph_name_2D, xlim=None, ylim=None):
    ...
    for i in np.unique(targets):
        ...
        plt.scatter(embeddings[inds,0], embeddings[inds,1], alpha=0.7, color=colors[count],marker=marker[count],s=100)
        count=count+1
    if xlim:
